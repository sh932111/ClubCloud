...
//		    mDbHelper.close();
	...
	public void setList()
	{
	    ...
	    MyAdapter adapter = new MyAdapter(ShowTravelList.this,
	    		cs1,
	    		cs3,
	    		cs4,
	    		cs5);
...
//		    	   
		    	   ...
		    	   Intent intent = new Intent(ShowTravelList.this ,ShowTravelDetail.class);
	...
	{
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0 && list_index == 1) 
		{
