...
//		         strCols,// Which columns to return
	...
	public Cursor getAll() 
	{
	    return db.query(DATABASE_TABLE, //Which table to Select
//	         strCols,// Which columns to return
	    	 new String[] {KEY_ROWID,KEY_TITLE, KEY_ITEM, KEY_CREATED ,KEY_TimeDetail ,KEY_CHECK},
	         null, // WHERE clause
	         null, // WHERE arguments
	         null, // GROUP BY clause
	         null, // HAVING clause
	...
	//query single entry
		public Cursor get(String rowId) throws SQLException
		{
		    ...
		    Cursor mCursor =  db.query( DATABASE_TABLE, new String[] 
		    		{
		    			KEY_ROWID,KEY_TITLE, KEY_ITEM, KEY_CREATED ,KEY_TimeDetail ,KEY_CHECK
		    		},
		            KEY_CREATED + " = ?",
		            new String[]{ ""+ rowId +"" },
		            null, 
	...
	// add an entry
	public long create(Long ID ,String title, String detail,String time,String value,String check)
	{
	...
	public boolean updateAll(Long id ,String title ,String list,String time,String value) 
	{
		ContentValues args = new ContentValues();
