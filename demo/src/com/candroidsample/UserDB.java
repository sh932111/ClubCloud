...
//	    return db.query(DATABASE_TABLE, //Which table to Select
////	         strCols,// Which columns to return
//	    	 new String[] {KEY_USERNAME,KEY_PASSWORD, KEY_NAME, KEY_USERID ,KEY_DEVICETOKEN ,KEY_OS},
//	         null, // WHERE clause
//	         null, // WHERE arguments
//	         null, // GROUP BY clause
//	         null, // HAVING clause
...
//		}
	...
	// add an entry
	public long create(String username ,String password, String name,String user_id,String device_token,String device_os)
	{
